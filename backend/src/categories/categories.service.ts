...
export class CategoriesService {
    ...
    async update(id: number, updateCategoryDto: UpdateCategoryDto) {
        ...
        const nextParentId = updateCategoryDto.parentId ?? category.parentId ?? null;
        ...
        const nextUserId =
            updateCategoryDto.userId !== undefined ? updateCategoryDto.userId ?? null : category.userId;
        ...
        const payload: DeepPartial<Category> = {
            ...
            userId: nextUserId,
            sortOrder:
                updateCategoryDto.sortOrder !== undefined ? updateCategoryDto.sortOrder : category.sortOrder,
            level,
    ...
    private ensureParentOwnership(parent: Category | null, userId: number | null) {
    ...
    private ensureParentNotDescendant(parent: Category | null, categoryId: number) {
